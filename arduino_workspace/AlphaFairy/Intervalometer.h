...
void cpufreq_boost();
void interval_drawTimer(int8_t);
int32_t interval_calcTotal(uint8_t);
bool intervalometer_func(void *);
bool intervalometer_wait(int32_t, uint32_t, int32_t, const char *, bool, int32_t);
